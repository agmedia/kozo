<?php
// HTTP
define('HTTP_SERVER', 'http://localhost:8888/kozo/upload/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost:8888/kozo/upload/');

// DIR
define('DIR_APPLICATION', '/Applications/MAMP/htdocs/kozo/upload/catalog/');
