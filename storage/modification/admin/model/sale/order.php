...
class ModelSaleOrder extends Model {
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
                ...
                'paid_order'              => $order_query->row['paid_order'],
                'intereuropa'             => $order_query->row['intereuropa'],
	...
	public function getOrders($data = array()) {
		$sql = "SELECT o.order_id, o.payment_method, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, (SELECT oss.response FROM " . DB_PREFIX . "order_service oss WHERE oss.order_id = o.order_id) AS order_service, o.intereuropa, o.paid_order, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified FROM `" . DB_PREFIX . "order` o";
