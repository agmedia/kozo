...
class ControllerExtensionExtensionModule extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->session->data['error_pp'])) {
			$data['error_warning'] = $this->session->data['error_pp'];

			unset($this->session->data['error_pp']);
		}
            

		if (isset($this->session->data['error_so'])) {
			$data['error_warning'] = $this->session->data['error_so'];

			unset($this->session->data['error_so']);
		}
