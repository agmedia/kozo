...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		$this->load->language('extension/module/attemplate');
			...
			if ($this->user->hasPermission('access', 'extension/extension/l')) {
				$seo[] = array(
					'name'	   => 'About & License',
					'href'     => $this->url->link('extension/extension/l', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->config->get('module_atpresets_installed')==1) {
				if ($this->user->hasPermission('access', 'extension/module/attemplate')) {
					$attribute[] = array(
						'name'	   => $this->language->get('text_attemplate'),
						'href'     => $this->url->link('extension/module/attemplate', 'user_token=' . $this->session->data['user_token'], true),
						'children' => array()		
					);
				}	
			}			
			...
			if ($this->user->hasPermission('access', 'extension/report/adv_sales')) {
				$report[] = array(
					'name'	   => $this->language->get('text_report_adv_sales'),
					'href'     => $this->url->link('extension/report/adv_sales', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}				
            

			if ($this->user->hasPermission('access', 'extension/report/adv_products')) {
				$report[] = array(
