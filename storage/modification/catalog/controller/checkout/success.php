...
$this->load->model('extension/fbecommevnt');
			$data['fbecommevnt_chksuccess'] = $this->model_extension_fbecommevnt->getchksuccess($this->session->data['order_id']);
		  ...
		  $order_id = $this->session->data['order_id'];
            ...
            $data['order_products'] = $this->model_checkout_order->getOrderOptionsSku($order_id);
...
if(!empty($data['fbecommevnt_chksuccess'])) {
			$data['footer'] = $data['fbecommevnt_chksuccess'] . $data['footer'];
			}
