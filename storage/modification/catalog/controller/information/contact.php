...
$this->load->model('extension/fbecommevnt');
			$data['fbecommevnt_contactus'] = $this->model_extension_fbecommevnt->contactus();
			if(!empty($data['fbecommevnt_contactus'])) {
			$data['footer'] = $data['fbecommevnt_contactus'] . $data['footer'];
			}
