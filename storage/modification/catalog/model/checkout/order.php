...
class ModelCheckoutOrder extends Model {
	...
	public function getOrderOptionsSku($order_id) {
		$query = $this->db->query("SELECT oc_order_product.model, oc_order_option.value FROM oc_order_product  LEFT JOIN oc_order_option ON oc_order_product.order_product_id = oc_order_option.order_product_id  WHERE oc_order_product.order_id = '" . (int)$order_id . "'");
